...
import { forgotPassword, forgotpasswordType } from "@/schema/(rest Password)/forgotpassword.schema";
import forgotPasswordaction from "@/lib/actions/restPasswordActions/forgotPassword.action";
...
export default function Forgotpassword() {
  ...
  // end use form
    async function handlesendemail(values:forgotpasswordType){
      // console.log(values);
      setisLoading(true)
       try {
          ...
          <div className="card flex items-center w-[320px]  justify-center mx-auto md:w-[410px] xl:w-[510x] md:h-[280] ">
            ...
            <div className="content">
              ...
              <Form {...form}>
                ...
                >
                  <p className="sub-sub-heading">Type your email to send verfy code</p>
